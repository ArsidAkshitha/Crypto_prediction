...
def predict():
    ...
    # output = round(prediction[0], 2)
    model.forecast()
    return render_template('index.html', prediction_text='predicted Bitcoin closing price today will be closely to  {}'.format((model.forecast()+(model1.want_deviat())[2])))
...
def epredict():
    ...
    # output = round(prediction[0], 2)
    emodel.forecast()
    return render_template('index1.html', prediction_text='predicted eth closing price today will be closely to  {}'.format((emodel.forecast()+(emodel1.want_deviat())[2])))
